 ...
 */
static void do_desc_setup(uint32_t *desc, struct prime_rsa *data,
			     ...
			     const paddr_t desc_new_q)
{
	 ...
	 */
	if (p->length > (size_t)128 + check_len) {
 ...
 */
static enum caam_status run_primes(uint32_t *desc, struct prime_rsa *prime)
{
